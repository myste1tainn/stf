...
module.exports = db.ensureConnectivity(function(options) {
  ...
  devDealer.on('message', wirerouter()
    ...
    .on(wire.DeviceIntroductionMessage, function(channel, message, data) {
      console.log('!!!!!!')
      console.log('Dev Dealer on wire.DeviceRegisteredMessage channel::: ', String(channel))
      console.log('Dev Dealer on wire.DeviceRegisteredMessage message::: ', String(message))
      console.log('Dev Dealer on wire.DeviceRegisteredMessage data::: ', String(data))
      console.log('!!!!!!')
