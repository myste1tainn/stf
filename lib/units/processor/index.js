...
module.exports = db.ensureConnectivity(function(options) {
  ...
  console.log('ENDPOINT', options.endpoints.appDealer)
  ...
  appDealer.on('message', function(channel, data) {
    // ARNON: This is where message from device connection arrive
    // when one trying to spy on the screen and control the device.
    console.log('!!!!!!')
    console.log('App Dealer channel::: ', String(channel))
    console.log('App Dealer data::: ', String(data))
    console.log('!!!!!!')
  ...
  devDealer.on('message', function(a, b, c) {
    console.log('!!!')
    console.log(a, b, c)
  })
  ...
  devDealer.on('message', wirerouter()
    ...
    .on(wire.DeviceIntroductionMessage, function(channel, message, data) {
      console.log('!!!!!!')
      console.log('Dev Dealer on wire.DeviceIntrocutionMessage channel::: ', String(channel))
      console.log('Dev Dealer on wire.DeviceIntrocutionMessage message::: ', String(message))
      console.log('Dev Dealer on wire.DeviceIntrocutionMessage data::: ', String(data))
      console.log('!!!!!!')
    ...
    .on(wire.DeviceReadyMessage, function(channel, message, data) {
      console.log('DeviceReadyMessage', channel, message, data)
      console.log(message.serial, message.channel)
